    ...
    <section className="py-24 bg-[#050B07] relative overflow-hidden" id="studio">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="pt-4">
              <a 
                ...
                className="inline-flex items-center justify-center gap-3 w-full sm:w-auto px-8 py-4 rounded-xl bg-[#17b95b] hover:bg-[#149a4d] text-black font-black text-base uppercase tracking-wide transition-all shadow-[0_0_30px_rgba(23,185,91,0.2)] hover:scale-[1.02]"
              >
          ...
          >
            <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-[#17b95b]/30 to-emerald-500/0 blur-xl opacity-75" />
